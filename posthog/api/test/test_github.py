...
class TestProjectSecretAPIKeySecretAlert(APIBaseTest):
    ...
    @patch("posthog.api.github.verify_github_signature")
    @patch("posthog.api.github.send_project_secret_api_key_exposed")
    @patch("posthog.api.project_secret_api_key.send_project_secret_api_key_rolled")
    def test_finds_and_rolls_project_secret_api_key(self, mock_rolled, mock_exposed, mock_verify):
        mock_verify.return_value = None
        ...
        mock_rolled.assert_called_once()
        call_args = mock_rolled.call_args[0]
    ...
    @patch("posthog.api.github.send_project_secret_api_key_exposed")
    @patch("posthog.api.project_secret_api_key.send_project_secret_api_key_rolled")
    def test_legacy_team_secret_token_is_not_rolled(self, mock_rolled, mock_exposed, mock_verify):
        mock_verify.return_value = None
        ...
        mock_rolled.assert_not_called()

    @patch("posthog.api.github.verify_github_signature")
    @patch("posthog.api.github.send_project_secret_api_key_exposed")
    @patch("posthog.api.project_secret_api_key.send_project_secret_api_key_rolled")
    def test_unknown_phs_token_is_false_positive(self, mock_rolled, mock_exposed, mock_verify):
        mock_verify.return_value = None
    ...
    @patch("posthog.api.github.send_project_secret_api_key_exposed")
    @patch("posthog.api.project_secret_api_key.send_project_secret_api_key_rolled")
    def test_mixed_batch_labels_each_token_independently(self, mock_rolled, mock_exposed, mock_verify):
        mock_verify.return_value = None

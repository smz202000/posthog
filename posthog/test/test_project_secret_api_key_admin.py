...
class TestProjectSecretAPIKeyAdmin(BaseTest):
    ...
    def test_roll_rolls_key_and_notifies(self, mock_rolled: MagicMock):
    ...
    @patch("posthog.api.project_secret_api_key.send_project_secret_api_key_rolled")
    def test_roll_requires_staff(self, mock_rolled: MagicMock):

...
export interface engineeringAnalyticsLogicActions {
    ...
    loadBrokenTests: () => any;
    loadBrokenTestsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadBrokenTestsSuccess: (brokenTestsData: BrokenTestsData, payload?: any) => {
        brokenTestsData: BrokenTestsData;
        payload?: any;
    };
    loadCards: () => any;
    loadCardsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadCardsSuccess: (cards: CardsData, payload?: any) => {
        cards: CardsData;
        payload?: any;
    };
    loadFlakyTests: () => any;
    loadFlakyTestsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadFlakyTestsSuccess: (flakyTests: FlakyTestsData, payload?: any) => {
        flakyTests: FlakyTestsData;
        payload?: any;
    };
    loadGithubSources: () => any;
    loadGithubSourcesFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadGithubSourcesSuccess: (githubSources: GitHubSourceApi[], payload?: any) => {
        githubSources: GitHubSourceApi[];
        payload?: any;
    };
    loadPullRequests: () => any;
    loadPullRequestsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadPullRequestsSuccess: (pullRequests: PullRequestRow[], payload?: any) => {
        pullRequests: PullRequestRow[];
        payload?: any;
    };
    loadQuarantine: () => any;
    loadQuarantineFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadQuarantineSuccess: (quarantine: QuarantineData, payload?: any) => {
    ...
    loadRunFailureLogsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadRunFailureLogsSuccess: (runFailureLogsByRun: Record<number, RunFailureLogsApi>, payload?: {
        runId: number;
    }) => {
        runFailureLogsByRun: Record<number, RunFailureLogsApi>;
        payload?: {
    ...
    loadWorkflowHealthFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadWorkflowHealthSuccess: (workflowHealth: WorkflowHealthRow[], payload?: any) => {
        workflowHealth: WorkflowHealthRow[];
        payload?: any;
    };
    ...
    setScope: (sourceId: string | null, scopeRepo: string | null) => {
        scopeRepo: string | null;
        sourceId: string | null;
    };
    ...
    submitQuarantineFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    submitQuarantineSuccess: (quarantineSubmit: QuarantineRequestResultApi, payload?: {
        input: QuarantineSubmitInput;
    }) => {
...
export interface engineeringAnalyticsLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        filteredWorkflowHealth: (workflowHealth: WorkflowHealthRow[], workflowFilters: WorkflowFilters) => WorkflowHealthRow[];
        ...
        filters: (stateFilter: PRStateFilter, author: string | null, repo: string | null, ciStatusFilter: CIStatusFilter, search: string, stuckOnly: boolean, readyOnly: boolean, thrashOnly: boolean) => PullRequestFilters;
        activeCard: (stateFilter: PRStateFilter, ciStatusFilter: CIStatusFilter, stuckOnly: boolean, readyOnly: boolean, thrashOnly: boolean) => CardFilter | null;
        ...
        anyLoading: (cardsLoading: boolean, pullRequestsLoading: boolean, workflowHealthLoading: boolean, quarantineLoading: boolean) => boolean;
        notConnected: (cardsStatus: LoaderStatus, pullRequestsStatus: LoaderStatus, workflowHealthStatus: LoaderStatus) => boolean;
        ...
        quarantineFilters: (quarantineSearch: string, quarantineLifecycleFilter: QuarantineLifecycleFilter, quarantineModeFilter: QuarantineModeFilter, quarantineOwner: string | null) => QuarantineFilters;
        filteredQuarantineEntries: (quarantine: QuarantineData | null, quarantineFilters: QuarantineFilters) => QuarantineEntryRow[];
        ...
        activeQuarantineCard: (quarantineLifecycleFilter: QuarantineLifecycleFilter, quarantineModeFilter: QuarantineModeFilter) => QuarantineCard | null;
        ...
        activeSource: (githubSources: GitHubSourceApi[], sourceId: string | null, scopeRepo: any) => GitHubSourceApi | null;
...
export type engineeringAnalyticsLogicType = MakeLogicType<engineeringAnalyticsLogicValues, engineeringAnalyticsLogicActions, Record<string, any>, engineeringAnalyticsLogicMeta>;

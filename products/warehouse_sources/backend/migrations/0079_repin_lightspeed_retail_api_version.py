...
class Migration(migrations.Migration):
    ...
    operations = [
        # Reverse is a no-op: once repinned, a source on 2026-01 is indistinguishable from one
        # natively created on the new default, so downgrading every 2026-01 row would clobber
        # legitimate native pins.
        migrations.RunPython(repin_lightspeed_retail_api_version, migrations.RunPython.noop, elidable=True),
    ]
